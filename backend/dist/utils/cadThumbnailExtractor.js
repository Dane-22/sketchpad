...
exports.extractSkpThumbnail = extractSkpThumbnail;
exports.extractDwgThumbnail = extractDwgThumbnail;
exports.extractPlanImageFromFile = extractPlanImageFromFile;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
/**
 * Extracts embedded PNG, JPEG, or BMP image stream from a SketchUp (.skp / .skb) file.
 */
function extractSkpThumbnail(buffer) {
 ...
 */
function extractDwgThumbnail(buffer) {
 ...
 */
function extractPlanImageFromFile(filePath) {
